...
To measure diversity, we use Shannon’s diversity index (H) as it is commonly used for species diversity and accounts for both richness and evenness of the species present. The Shannon’s diversity index (H) is calculated as follows: 
                     $H = -\sum_{i=1}^Sp_ilnp_i$
